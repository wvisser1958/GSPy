...
class CompressorMapPlot(MapPlot):
    ...
    def GetMapData(self):
        ...
        # scale PR - 1 (not just PR)!
        self.compPRArrayValues    = (self.compressorObject.GetPrValues()-1)   * self.compressorObject.SFmap_PR + 1
        ...
        # scale PR - 1 (not just PR)!
        self.compSlPRArrayValues  = (self.compressorObject.GetSlPrValues()-1) * self.compressorObject.SFmap_PR + 1
