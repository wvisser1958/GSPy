...
def main():
    turbojet = TSystemModel('Turbojet_DPeq')
    ...
    compressor1 = TCompressor(turbojet, 'compressor1',turbojet.maps_dir_path / 'compmap.map' , None, 2, 3, 1, 16540, 0.825, 1, 0.75   , 6.92, 'GG', None)
    ...
    turbine1 =    TTurbine(turbojet,    'turbine1'   , turbojet.maps_dir_path / 'turbimap.map', None, 4, 5, 1, 16540, 0.88 , 1, 0.50943, 0.99, 'GG', None)
    # option for polytropic efficiency, uncomment next line
    ...
    turbojet.Run_DP_simulation( [(compressor1,  "PRdes",    turbine1.map, "SFmap_Wc", 0.4),
                                 (inlet1,       "Wdes",     exhaustnozzle,  "FG", 15)] )
