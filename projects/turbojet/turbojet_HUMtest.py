...
def main():
    turbojet = TSystemModel('Turbojet HUM', model_file = __file__)
    ...
    compressor1 = TCompressor(turbojet,         # owning system model object
                              ...
                              1,                # shaft id, strings are allowed as well (e.g. 'gg'), but for simplicity we use integers here
                              16540,            # design rpm
    ...
    combustor1 = TCombustor(turbojet,       # owning system model object
                            ...
                            288.15,         # Fuel temperature K           # If None, then Tfuel is assumed to be equal to temperature of entry air flow
