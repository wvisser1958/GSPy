...
class Turbojet(BaseGasTurbineModel):
    ...
    def build_model(self):
        # TSystemModel owns the project paths; maps live in data/maps
        comp_map = 'compmap.map'
        turb_map = 'turbimap.map'

        return [
            # Ambient is NOT listed here; it is created internally by TSystemModel
