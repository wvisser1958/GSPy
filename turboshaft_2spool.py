...
def main():
    ...
    turbine_gg      =  TTurbine(   'GGT'   ,'turbimap.map', None, 4, 45, '_gg', 4780, 0.8 , 1, 0.50943, 0.99, 'GG', None)

    turbine_PT =    TTurbine(   'PT'   ,'turbimap.map', None, 45, 5, '_pt', 3000, 0.91 , 1, 0.8, 0.99, 'PT', None)
